...
cp ../ud/UD_Romanian-RRT/ro_rrt-ud-train.conllu $LEMMA_DATA_DIR/rrt.train.in.conllu
cp ../ud/UD_Romanian-RRT/ro_rrt-ud-dev.conllu $LEMMA_DATA_DIR/rrt.dev.in.conllu
cp ../ud/UD_Romanian-RRT/ro_rrt-ud-dev.conllu $LEMMA_DATA_DIR/rrt.dev.gold.conllu
